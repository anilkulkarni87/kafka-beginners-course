...
public class ElasticSearchConsumerBulkRequest {
    public static void main(String[] args) throws IOException {
        Logger logger = LoggerFactory.getLogger(ElasticSearchConsumerBulkRequest.class.getName());
       ...
       // String jsonString = "{\"foo\":\"bar\"}";
        ...
        while(true){
            ...
            Integer consumerRecordsCount = consumerRecords.count();
            logger.info("Received "+ consumerRecordsCount +" records");
